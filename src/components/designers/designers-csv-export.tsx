...
export function DesignersCsvExport({
  ...
  return (
    <button
      type="button"
      onClick={download}
      className="inline-flex h-8 shrink-0 items-center rounded-lg bg-app-accent px-4 text-sm font-semibold leading-5 text-white transition-colors hover:bg-app-accent-hover"
    >
      Экспорт в CSV
    </button>
  );
